          ...
          {features.map((feature, index) => (
            ...
            >
              <CardContainer key={index}>
                <CardBody className="hover:border-cuptime-red flex h-[250px] w-fit flex-col items-center justify-center gap-4 rounded-lg border-2 border-transparent p-6 text-center transition-all duration-300 select-none lg:items-start lg:text-left">
