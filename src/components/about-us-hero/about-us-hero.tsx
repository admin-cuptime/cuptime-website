          ...
          <div className="flex flex-col items-center justify-center gap-8">
            ...
            >
              <AuroraText colors={['#ed1c24', '#ff7654', '#ed1c24', '#ff7654']}>
                <AuroraText colors={['#FFFFFF']}>Rooted in Tradition.</AuroraText>
                {' '}Driven by Passion.
              </AuroraText>
            </motion.div>
            ...
            >
              <button className="bg-cuptime-black w-full rounded-lg px-4 py-2 text-sm font-semibold text-white md:px-6 md:py-3 md:text-base">
                Order Now
              </button>
              <button className="from-cuptime-orange to-cuptime-red w-full rounded-lg bg-gradient-to-tr px-4 py-2 text-sm font-semibold text-white md:py-3 md:text-base text-nowrap">
                Explore Our Journey
              </button>
            </motion.div>
          </div>
